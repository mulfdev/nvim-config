...
-- Function to prompt for input and replace all occurrences
function ReplaceAll()
  local search = vim.fn.input 'Enter the search text: '
  local replace = vim.fn.input 'Enter the replacement text: '
  vim.cmd('%s/' .. search .. '/' .. replace .. '/g')
end

-- Function to prompt for input and replace one occurrence at a time with confirmation
...
-- Map <Leader>ra to replace all occurrences
vim.api.nvim_set_keymap('n', '<Leader>ra', ':lua ReplaceAll()<CR>', { noremap = true, silent = true })

-- Map <Leader>rc to replace one occurrence at a time with confirmation
vim.api.nvim_set_keymap('n', '<Leader>rc', ':lua ReplaceConfirm()<CR>', { noremap = true, silent = true })
-- Map <leader>cw to <C-w>c to close the current window
